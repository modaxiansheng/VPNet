...
def main():
    ...
    cfg.ROOT_DIR = (Path(os.environ['HOME']) / 'work/work_dir').resolve()

    # output_dir = (Path(os.environ['HOME']) / 'work/work_dir').resolve()/'output' / cfg.EXP_GROUP_PATH / cfg.TAG / args.extra_tag    
