...
class EdgeConv(torch.nn.Module):
    ...
    def __init__(self, in_channels, out_channels, act='relu', norm=None, bias=True, diss=True, merge=True, att=True):
        ...
        self.linear3 = BasicConv([out_channels, 1 if merge else int(out_channels/4)], act=None, norm=None, bias=False)
    ...
    def forward(self, x, index, pos):
        ...
        # # conv1 = Conv1d(in_channels=2,out_channels=128,kernel_size=3,padding=1,stride=1).to(device)
        # # feature = conv1(feature)
        # # print(type(feature))
        # # 
