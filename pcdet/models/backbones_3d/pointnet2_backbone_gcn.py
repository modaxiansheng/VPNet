...
class PointNet2MSG_gcn2(nn.Module):
    def __init__(self, model_cfg, input_channels, **kwargs):
        super().__init__()
        self.model_cfg = model_cfg
        ...
        # ________GCN模块
        print('gcn3pointnet2_backbonegcn')
        self.gcn2 = PlainGCNcopy(model_cfg,NUM_FILTERS=[128],input_channels=128)
        # self.gcn2 = PlainGCNcopy(model_cfg,NUM_FILTERS=[1024],input_channels=1024)
    ...
    def forward(self, batch_dict):
        ...
        # gcn2
        point_features1 = l_features[4].permute(0, 2, 1).contiguous()  # (B, N, C) 2 64 1024
        ...
        l_features[4] = (self.gcn2(dict1))['point_features']
